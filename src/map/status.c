...
int status_calc_pc_(struct map_session_data* sd, enum e_status_calc_opt opt)
{
	...
	memset (sd->param_bonus, 0, sizeof(sd->param_bonus)
		...
		+ sizeof(sd->skill_no_require_item) // [Cydh/PServeRO]
		+ sizeof(sd->oneshootonekill_class) // [Cydh/PServeRO]
		+ sizeof(sd->oneshootonekill_race) // [Cydh/PServeRO]
		);
	...
	memset(&sd->autospell,0,sizeof(sd->autospell)
		...
		+ sizeof(sd->skill_no_require) // [Cydh/PServeRO]
		+ sizeof(sd->oneshootonekill_mob) // [Cydh/PServeRO]
	);
